...
fn main() {
    ...
    terminal::with_colors(Color::from_rgb(0xFA, 0xAF, 0x29),
                          Color::from_rgb(0x05, 0x50, 0xD6),
                          || terminal::print_xy(0, 1, "Colerd"));
    for (i, c) in "Coloured letters with pixel-offset!".chars().enumerate() {
        terminal::put_ext(Point::new(i as i32, 2),
                          Point::new(i as i32, i as i32),
                          c,
                          &vec![Color::from_rgb(0xFF, 0x00, 0x00),
